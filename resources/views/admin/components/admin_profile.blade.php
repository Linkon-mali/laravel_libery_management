        ...
        <div class="col-md-6 col-lg-4">
            ...
            <div>
                ...
                <div class="user-header-info">
                    <h2 class="user-name">{{ $loginAdmin->name }}</h2>
                    <h5 class="user-position">{{ ($loginAdmin->status == 'active') ? 'Super Admin': 'Admin' }}</h5>
            ...
            <div class="panel bg-scale-0 b-primary bt-sm mt-xl">
                <div class="panel-content">
                    ...
                    <ul class="user-contact-info ph-sm">
                        <li><b><i class="color-primary mr-sm fa fa-envelope"></i></b> {{ $loginAdmin->email }} </li>
                        <li><b><i class="color-primary mr-sm fa fa-phone"></i></b> {{ $loginAdmin->phone }} </li>
