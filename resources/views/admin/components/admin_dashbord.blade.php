    ...
    <div class="content-header">
        ...
        <div class="leftside-content-header">
            <ul class="breadcrumbs">
                <li><i class="fa fa-home" aria-hidden="true"></i><a href="javascript: avoid(0)">Admin Dashboard</a></li>
            </ul>
        </div>
    </div>
    <!-- =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-= -->
                            ...
                            <div class="panel-content">
                                <div class="row">
                                    ...
                                    <div class="col-xs-8">
                                        ...
                                        <h1 class="title color-primary"> {{$users_count}}</h1>
                                    </div>
                                </div>
                            </div>
                        </a>
                        ...
                        <a href="#">
                            <div class="panel-content">
                                <div class="row">
                                    ...
                                    <div class="col-xs-8">
                                        <h4 class="subtitle color-darker-2">Total Admin</h4>
                                        <h1 class="title color-w"> {{$admins_count}}</h1>
                                    </div>
                                </div>
                            </div>
                        </a>
