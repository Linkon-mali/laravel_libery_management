        ...
        <div class="page-header">
            ...
            <div class="rightside-header">
                        ...
                        <div class="dropdown-box basic">
                            ...
                            <div class="drop-content">
                                <div class="widget-list list-left-element list-sm">
                                    <ul>
                                        <li>
                                            <a href="{{ route('browed_book') }}">
                                                <div class="left-element"><i class="fa fa-warning color-warning"></i></div>
                                                <div class="text">
                                                    <span class="title">@yield('notificationB') Book</span>
                                                    <span class="subtitle">Borowed Today</span>
                                                </div>
                                            </a>
                                        </li>
                                    </ul>
                ...
                <div class="header-section" id="user-headerbox">
                    <div class="user-header-wrap">
                        <div class="user-photo">
                            <span>
                                @if($loginAdmin->image)
                                <img style="width: 30px;" alt="profile photo" src="{{ asset('/') }}assets/images/admin/{{$loginAdmin->image}}" />
                                @else
                                <img style="width: 30px" alt=" profile photo" src="{{ asset('/') }}assets/images/admin/people.png" />
                                @endif
                            </span>
                        </div>
                        <div class="user-info">
                            <span class="user-name"> {{$loginAdmin->name}}</span>
                            <span class="user-profile">{{ ($loginAdmin->status == 'active') ? 'Super Admin': 'Admin' }}</span>
                        </div>
                    ...
                    <div class="user-options dropdown-box">
                        <div class="drop-content basic">
                            <ul>
                                <li> <a href="{{ route('admin_profile') }}"><i class="fa fa-user" aria-hidden="true"></i> Profile</a></li>
                                <li> <a href="{{ route('admin_update') }}"><i class="fa fa-lock" aria-hidden="true"></i> Update Profile</a></li>
                                <li><a href="{{ route('loginAdmin_delete') }}"><i class="fa fa-cog" aria-hidden="true"></i> Delete Profile</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="header-section">
                    <a href="{{ route('admin_logout') }}" data-toggle="tooltip" data-placement="left" title="Logout" onclick="event.preventDefault();
                    ...
                    <div class="nano-content">
                        <nav>
                            <ul class="nav nav-left-lines" id="main-nav">
                                <!--HOME-->
                                <li class="active-item"><a href="{{ route('admin') }}"><i class="fa fa-home" aria-hidden="true"></i><span>Dashboard</span></a></li>
                                <!--UI ELEMENTENTS-->
                                <li class="has-child-item close-item">
                                    <a><i class="fa fa-users" aria-hidden="true"></i><span>Admin</span></a>
                                    <ul class="nav child-nav level-1">
                                        <li><a href="{{ route('admin_add') }}">Add Admin</a></li>
                                        <li><a href="{{ route('all_admin') }}">All Admin</a></li>
                                    </ul>
                                </li>
                                <li class="has-child-item close-item">
                                    <a><i class="fa fa-book" aria-hidden="true"></i><span>Books</span></a>
                                    <ul class="nav child-nav level-1">
                                        <li><a href="{{ route('add_book') }}">Add Book</a></li>
                                        <li><a href="{{ route('all_book') }}">All Books</a></li>
                                        <li><a href="{{ route('browed_book') }}">Browed Books</a></li>
                                        <li><a href="{{ route('return_book_list') }}">Return Books</a></li>
                                    </ul>
                                </li>
                                <!--CHARTS-->
                                ...
                                <li class="has-child-item close-item">
                                    ...
                                    <ul class="nav child-nav level-1">
                                        <li><a href="{{ route('all_student') }}">All Students</a></li>
                                        <li><a href="{{ route('deleted_student') }}">Deleted Student</a></li>
                                    </ul>
                                </li>
